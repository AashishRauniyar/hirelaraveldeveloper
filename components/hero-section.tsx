        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              Start in 7 days with elite, security-cleared engineers. US-based
              project oversight, 100% client retention, and rapid onboarding.
              Scale your web initiatives with HLD—no HR friction, no hidden
              costs.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-3 text-sm text-gray-700">
              <div className="flex items-start">
                ...
                <span>
                  <strong>Top 3% Vetted Talent:</strong> Only 1 in 30 developers
                  pass our rigorous selection process
                </span>
              </div>
              <div className="flex items-start">
                <Star className="w-4 h-4 mr-2 text-purple-600 flex-shrink-0 mt-1" />
                <span>
                  <strong>Cost Savings Up to 60%:</strong> Scale your team at
                  $18–$32/hr—half the average US rate
                </span>
              </div>
              <div className="flex items-start">
                <Star className="w-4 h-4 mr-2 text-purple-600 flex-shrink-0 mt-1" />
                <span>
                  <strong>Rapid Onboarding:</strong> Start with your Laravel
                  expert in as little as 7 days
                </span>
              </div>
              <div className="flex items-start">
                <Star className="w-4 h-4 mr-2 text-purple-600 flex-shrink-0 mt-1" />
                <span>
                  <strong>100% Client Retention:</strong> Trusted by startups,
                  agencies, and enterprises across 4 continents
                </span>
              </div>
              <div className="flex items-start sm:col-span-2">
                <Star className="w-4 h-4 mr-2 text-purple-600 flex-shrink-0 mt-1" />
                <span>
                  <strong>US-Based Project Oversight:</strong> Seamless
                  communication, real-time updates, zero timezone headaches
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              ...
              <Button
                ...
                onClick={() => {
                  gaEvents.trackHireClick("hero", "+1 315 215 2005");
                  // Add your phone call logic here
                  window.location.href = "tel:+13152152005";
                }}
              >
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                <div className="text-center mb-3">
                  <span className="text-sm font-semibold text-gray-700">
                    Trusted & Certified By Leading Tech Companies
                  </span>
                </div>
